...
const ProgressCard = (props) => {
  // تعريف متغيرات محلية للوصول للقيم عبر props.name مع تحديد قيم افتراضية
  ...
  return (
    <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-center justify-between w-full  mx-auto font-sans" dir="rtl">
       {/* القسم الأيسر (دائرة التقدم باستخدام DaisyUI) */}
      <div className="flex items-center justify-center ml-4">
        <div
          className="radial-progress text-[#077187] font-bold text-3xl"
          style={{
            "--value": percentage, // استخدام القيمة المحسوبة هنا
            "--size": "9rem",
            "--thickness": "12px",
          }}
          role="progressbar"
