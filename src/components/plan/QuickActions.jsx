...
const QuickActions = () => {
  return (
    <div
      ...
      dir="rtl"
    >
      <div className="flex items-center justify-start gap-2 text-base-content font-bold font-1 text-lg mb-4">
        <svg
         className="w-5 h-5 text-cyan-600 dark:text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
